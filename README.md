...
Este projeto tem como objetivo desenvolver e aplicar práticas de desenvolvimento frontend com foco em usabilidade, modularidade, responsividade, comunicação entre componentes e integração com serviços web.
